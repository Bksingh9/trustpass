...
- Worker deployment: the `Deploy TRUSTPASS Live Worker` workflow can resolve an existing D1 database by name or create it before applying migrations and running the deployed E2E proof.
