...
- Public launch checks should include tests, CodeQL code scanning, the deployed API proof, the public gateway proof, CodeRabbit review when authenticated, and security hardening review for auth, tenancy, audit, and data-classification boundaries.
